  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fdfcfb] via-[#e2d1c3] to-[#fdfcfb]">
      <div className="container mx-auto p-4">
        <h1 className="text-2xl font-semibold mb-4 text-center">{t('shopping_cart_title')}</h1>
        {cartItems.length === 0 ? (
            ...
            <div className="flex w-full items-center justify-center flex-wrap ">
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="m-3">
                    <p className="text-gray-700">{t('author')}: {item.author}</p>
                    <p className="text-gray-700">{t('genre')}: {item.genre}</p>
                    <p className="text-gray-700">{t('publish_date')}: {item.published}</p>
                    <div className="flex items-center justify-between mt-4">
                      <div className="text-gray-700">{t('quantity')}: {item.quantity}</div>
                    </div>
                    <button
