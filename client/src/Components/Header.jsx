...
import { applicationLanguagesDropdown } from "../utils";
...
const Header = () => {
  ...
  const handleCartClick = () => {
    if (isTrue) {
      ...
      toast.error(t("please_login_access_cart"), {
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="content flex max-[500px]:flex-col-reverse flex-row items-center gap-4 ">
          ...
          <nav className="space-x-4 flex items-center">
            ...
            <Dropdown
              value={locale}
              options={applicationLanguagesDropdown}
              onChange={onChangeLanguage}
              className={"hidden sm:block w-36 max-w-xs"}
            />
          </nav>
        </div>
      </div>
